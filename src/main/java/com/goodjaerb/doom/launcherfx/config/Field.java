...
public enum Field {
    ...
    FILE("File:", InputType.BROWSE, 
            ...
            createHelpMap(
                    ...
                    "Enter the filename of the mod.\nThis can be just the filename or a relative path to the file (relative to your '%CONFIGHOME%/mods' directory), or an absolute path.",
